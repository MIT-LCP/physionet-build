...
class TestForms(TestCase):
    ...
    def test_set_password_form(self):
        ...
        self.run_test_forms(
            {'new_password2':['This password is too short. It must contain at least 8 characters.', 'This password is too weak.']})
    ...
    def test_user_creation_form(self):
        self.create_test_forms(UserCreationForm, {'email':'tester0@mit.edu',
            ...
            'last_name':'Bot', 'password1':'weakweakweak', 'password2':'weakweakweak'})
