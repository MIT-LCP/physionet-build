...
from user.models import training_report_path
...
def migrate_forward(apps, schema_editor):
    ...
    for credential_application in CredentialApplication.objects.all():
        ...
        ProjectFiles().mkdir(os.path.join(ProjectFiles().file_root, 'trainings', credential_application.slug))
        new_name = os.path.join('trainings', credential_application.slug, 'training-report.pdf')
...
def migrate_backward(apps, schema_editor):
    ...
    ProjectFiles().rm(os.path.join(ProjectFiles().file_root, 'trainings'))
