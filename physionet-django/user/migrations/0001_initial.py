    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('training_completion_report', models.FileField(upload_to=user.models.training_report_path, validators=[django.core.validators.FileExtensionValidator(['pdf'], 'File must be a pdf.')])),
