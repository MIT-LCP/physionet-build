...
urlpatterns = [
    ...
    path('settings/trainings/', views.edit_trainings, name='edit_trainings'),
    path('settings/trainings/<int:training_id>/', views.edit_trainings_detail, name='edit_trainings_detail'),
