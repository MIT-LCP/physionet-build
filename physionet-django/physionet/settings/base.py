...
ENABLE_EVENT_REGISTRATION_AUTO_REJECTION = config('ENABLE_EVENT_REGISTRATION_AUTO_REJECTION', default=False, cast=bool)

DEFAULT_NUMBER_OF_APPLICATIONS_TO_REJECT_PER_EVENT = config('DEFAULT_NUMBER_OF_APPLICATIONS_TO_REJECT_PER_EVENT',
                                                            default=5, cast=int)
