...
db2 = Database(name='STAFF-III Database', slug="staffiii", license = License.objects.get(name='MIT'), overview = staffiiioverview, publishdate="2017-01-22", collection=staffiiicollection, filedescription=staffiiifiledescription, DOI='doi:10.13526/C2G329')
db2.save()
...
db3 = Database(name='MGH Database', slug="mghdb", license = License.objects.get(name='MIT'), overview = mghdboverview, publishdate="1992-05-01", collection=mghdbcollection, filedescription=mghdbfiledescription, DOI='doi:10.53531/C2V628')
db3.save()
