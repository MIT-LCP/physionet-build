...
class FederatedProject(models.Model):
    ...
    def get_resource_type_display_name(self):
        ...
        return resource_types.get(self.resource_type, 'Unknown')

    def get_access_policy_display_name(self):
        """Get human-readable access policy name."""
        access_policies = {
            0: 'Open',
            1: 'Restricted',
            2: 'Credentialed',
        ...
        return access_policies.get(self.access_policy, 'Unknown')
...
class FederationSyncLog(models.Model):
    ...
    projects_deleted = models.IntegerField(
        default=0,
        help_text='Projects marked as stale/deleted'
    )
