...
class EditLog(models.Model):
    ...
    soundly_produced = models.BooleanField(null=True)
    well_described = models.BooleanField(null=True)
    open_format = models.BooleanField(null=True)
    data_machine_readable = models.BooleanField(null=True)
    reusable = models.BooleanField(null=True)
    no_phi = models.BooleanField(null=True)
    pn_suitable = models.BooleanField(null=True)
    ethics_included = models.BooleanField(null=True)
