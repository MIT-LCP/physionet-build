...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=['site', '-started_at'],
                name='search_fede_site_id_a35c25_idx',
            ),
        ),
        migrations.AddIndex(
            model_name='federationsynclog',
            index=models.Index(
                ...
                name='search_fede_status_d61696_idx',
            ),
        ),
        migrations.AddIndex(
            model_name='federatedproject',
            index=models.Index(
                fields=['public_project_uuid'],
                name='search_fede_public__7ccd7c_idx',
            ),
        ),
        migrations.AddIndex(
            model_name='federatedproject',
            index=models.Index(
                fields=['slug', 'version'],
                name='search_fede_slug_e5662d_idx',
            ),
        ),
        migrations.AddIndex(
            model_name='federatedproject',
            index=models.Index(
                ...
                name='search_fede_publish_b25fc1_idx',
            ),
        ),
        migrations.AddIndex(
            model_name='federatedproject',
            index=models.Index(
                ...
                name='search_fede_resourc_ab7754_idx',
            ),
        ),
        migrations.AddIndex(
            model_name='federatedproject',
            index=models.Index(
                fields=['title'],
                name='search_fede_title_bfd9cb_idx',
            ),
        ),
